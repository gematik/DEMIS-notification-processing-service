...
## Release 2.15.2
- added more detailed text for null message after validation failed (e.g. email)
...
- made header forwarding fit for split of fhir core package
- removed FEATURE_FLAG_CODEMAPPING_SERVICE_BASE
- changed exception message for non-routable notifications
- added FEATURE_FLAG_NEW_ERROR_MESSAGE_FOR_FAILED_ROUTING
- reduced FEATURE_FLAG_NOTIFICATIONS_7_3 use to only check incoming notifications but not for processing intermediate steps
- refactored pdf generation to always use pre encrypted bundles
